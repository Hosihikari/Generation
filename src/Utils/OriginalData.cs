...
public struct Class
{
    [JsonPropertyName("parent_types")] public List<string> ParentTypes { get; set; }
    [JsonPropertyName("vtbl_entry")] public List<string> VtblEntry { get; set; }
    [JsonPropertyName("child_types")] public List<string> ChildTypes { get; set; }
...
public struct Item
{
    ...
    [JsonPropertyName("flag_bits")] public int FlagBits { get; set; }
    ...
    [JsonPropertyName("symbol_type")] public int SymbolType { get; set; }
